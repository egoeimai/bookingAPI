...
try:
    ...
    if conn.is_connected():
        ...
        for item in boats_bookings:
            ...
            val_booking = (item["id"], item["yachtId"], item["status"], item["dateFrom"], item["dateTo"], item["baseFromId"], item["baseToId"], item["optionExpirationDate"], str(d_dateFrom + d_dateTo))
